...
PARAM$trainingstrategy$semilla_azar <- 697157 # Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar <- 697157 # Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
